            ...
            <div class="row pt-4">
                <div class="card table-overflow">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form action='{{ route('update_blog_save') }}' method="post" id="myform">
                                @csrf
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row d-flex mb-3">
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input class="form-control f-14" required name="mata_title" type="text" value="{{$blog->mata_title}}">
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                            <label class="fw-bold mb-2" for="">Mata Tags</label>
                                            <input class="form-control f-14" required name="mata_tags" type="text" value="{{$blog->mata_tags}}">
                                        </div>
                                        <div class="form-group col-md-4 mb-3">
                                            <label class="fw-bold mb-2" for="">Cover Image</label>
                                            <input class="form-control f-14"  name="cover_picture" accept=".png, .jpg, .jpeg"type="file" value="">
                                        </div>
                                        <div class="form-group col-md-12 mb-3">
                                            <label class="fw-bold mb-2" for="">Mata Description</label>
                                            <input class="form-control f-14" required name="mata_description" type="text" value="{{$blog->mata_description}}">
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group col-md-6 mb-3">
                                                            ...
                                                            <input class="form-control f-14"
                                                                   name="{{ $language->short_name }}[subject]"
                                                                   type="text" value="{{$blog->details[$key]->subject}}">
    ...
    <script>
        ...
        tinymce.init({
            ...
            file_picker_callback: function(cb, value, meta) {
                ...
                input.setAttribute('type', 'file'); // Fixed the typo here
                input.setAttribute('accept', 'image/*'); // Fixed the typo here
                input.onchange = function () {
                    ...
                    reader.onload = function () {
                        ...
                        // var absoluteImageUrl = tinymce.activeEditor.getParam('document_base_url') +
                        //     'storage/app/public/uploads/' + file.name;
