...
function addseparator(price){
    ...
    if(price != ""){
        ...
        price=parsedPrice.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, sap);
        return price;
...
$(document).on('ready', function() {
    ...
    $(".slider-range-price").slider({
        ...
        slide: function( event, ui ) {
            ...
            $( ".amount"  ).val( addseparator(ui.values[ 0 ]) );
            $( ".amount2"  ).val( addseparator(ui.values[ 1 ]) );
    ...
    // for apartment_grossm2
    $(".slider-range-apartment_grossm2").slider({
        ...
        values: [ 1, 1000 ],
        slide: function( event, ui ) {
            $( ".min_apartment_grossm2"  ).val( addseparator(ui.values[ 0 ]));
            $( ".max_apartment_grossm2"  ).val( addseparator(ui.values[ 1 ]));
        }
    });
    $(".min_apartment_grossm2").change(function() {
        $(".slider-range-apartment_grossm2").slider('values',0,$(this).val());
    });
    $(".max_apartment_grossm2").change(function() {
        $(".slider-range-apartment_grossm2").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-apartment_bed").slider({
        range: true,
        min: 0,
        max: 15,
        values: [ 0, 15 ],
        slide: function( event, ui ) {
            $( ".min_apartment_bed"  ).val( ui.values[ 0 ] );
            $( ".max_apartment_bed"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_apartment_bed").change(function() {
        $(".slider-range-apartment_bed").slider('values',0,$(this).val());
    });
    $(".max_apartment_bed").change(function() {
        $(".slider-range-apartment_bed").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-apartment_bath").slider({
        range: true,
        min: 0,
        max: 5,
        values: [ 0, 5 ],
        slide: function( event, ui ) {
            $( ".min_apartment_bath"  ).val( ui.values[ 0 ] );
            $( ".max_apartment_bath"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_apartment_bath").change(function() {
        $(".slider-range-apartment_bath").slider('values',0,$(this).val());
    });
    $(".max_apartment_bath").change(function() {
        $(".slider-range-apartment_bath").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-apartment_living").slider({
        range: true,
        min: 0,
        max: 5,
        values: [ 0, 5 ],
        slide: function( event, ui ) {
            $( ".min_apartment_living"  ).val( ui.values[ 0 ] );
            $( ".max_apartment_living"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_apartment_living").change(function() {
        $(".slider-range-apartment_living").slider('values',0,$(this).val());
    });
    $(".max_apartment_living").change(function() {
        $(".slider-range-apartment_living").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-apartment_floors").slider({
        range: true,
        min: 0,
        max: 70,
        values: [ 0, 70 ],
        slide: function(event, ui) {
            // For min value
            if (ui.values[0] === 0) {
                $(".min_apartment_floors").val('').attr('placeholder', 'Basement');
            } else if (ui.values[0] === 1) {
                $(".min_apartment_floors").val('').attr('placeholder', 'Ground');
            } else {
                $(".min_apartment_floors").val(ui.values[0] - 1).removeAttr('placeholder');
            }
        
            // For max value, we assume no custom text for max
            $(".max_apartment_floors").val(ui.values[1]);
        }

    });
    $(".min_apartment_floors").change(function() {
        $(".slider-range-apartment_floors").slider('values',0,$(this).val());
    });
    $(".max_apartment_floors").change(function() {
        $(".slider-range-apartment_floors").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-apartment_building_floors").slider({
        range: true,
        min: 0,
        max: 70,
        values: [ 0, 70 ],
        slide: function( event, ui ) {
            ...
            $( ".min_apartment_building_floors"  ).val( ui.values[ 0 ] );
            $( ".max_apartment_building_floors"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_apartment_building_floors").change(function() {
        $(".slider-range-apartment_building_floors").slider('values',0,$(this).val());
    });
    $(".max_apartment_building_floors").change(function() {
        $(".slider-range-apartment_building_floors").slider('values',1,$(this).val());
    });

// *************************************** villa *********************************
    // for apartment_grossm2
    $(".slider-range-villa_grossm2").slider({
        range: true,
        min: 1,
        max: 2500,
        values: [ 1, 2500 ],
        slide: function(event, ui) {
            ...
            // Adjust minValue based on different ranges
            if (minValue <= 500) {
                minValue = Math.round(minValue / 25) * 25;  // 0 to 500 with steps of 25
            } else if (minValue <= 1000) {
                minValue = Math.round((minValue - 500) / 100) * 100 + 500;  // 500 to 1,000 with steps of 100
            } else if (minValue <= 2500) {
                minValue = Math.round((minValue - 1000) / 250) * 250 + 1000;  // 1,000 to 2,500 with steps of 250
            }
    
            // Adjust maxValue based on different ranges
            if (maxValue <= 500) {
                maxValue = Math.round(maxValue / 25) * 25;  // 0 to 500 with steps of 25
            } else if (maxValue <= 1000) {
                maxValue = Math.round((maxValue - 500) / 100) * 100 + 500;  // 500 to 1,000 with steps of 100
            } else if (maxValue <= 2500) {
                maxValue = Math.round((maxValue - 1000) / 250) * 250 + 1000;  // 1,000 to 2,500 with steps of 250
            }
    
            // Update the min and max values with formatting
            $(".min_villa_grossm2").val(addseparator(minValue));
            $(".max_villa_grossm2").val(addseparator(maxValue));
        }
    });

    $(".min_villa_grossm2").change(function() {
        $(".slider-range-villa_grossm2").slider('values',0,$(this).val());
    });
    $(".max_villa_grossm2").change(function() {
        $(".slider-range-villa_grossm2").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
   $(".slider-range-villa_landm2").slider({
        range: true,
        min: 1,
        max: 25000,
        values: [1, 25000], // Initial values (will be corrected on create)
        create: function(event, ui) {
            var initialMinValue = $(this).slider("values", 0);
            var initialMaxValue = $(this).slider("values", 1);
    
            // Adjust initial minValue based on different ranges
            if (initialMinValue <= 1000) {
                initialMinValue = Math.round(initialMinValue / 50) * 50; // 0 to 1,000 with steps of 50
            } else if (initialMinValue <= 5000) {
                initialMinValue = Math.round((initialMinValue - 1000) / 250) * 250 + 1000; // 1,000 to 5,000 with steps of 250
            } else {
                initialMinValue = Math.round((initialMinValue - 5000) / 1000) * 1000 + 5000; // 5,000 to 25,000 with steps of 1,000
            }
    
            // Adjust initial maxValue based on different ranges
            if (initialMaxValue <= 1000) {
                initialMaxValue = Math.round(initialMaxValue / 50) * 50; // 0 to 1,000 with steps of 50
            } else if (initialMaxValue <= 5000) {
                initialMaxValue = Math.round((initialMaxValue - 1000) / 250) * 250 + 1000; // 1,000 to 5,000 with steps of 250
            } else {
                initialMaxValue = Math.round((initialMaxValue - 5000) / 1000) * 1000 + 5000; // 5,000 to 25,000 with steps of 1,000
            }
    
            // Set the adjusted values as the new slider values
            $(this).slider("values", 0, initialMinValue);
            $(this).slider("values", 1, initialMaxValue);
    
            // Update the input fields
            $(".min_villa_landm2").val(addseparator(initialMinValue));
            $(".max_villa_landm2").val(addseparator(initialMaxValue));
        },
        slide: function(event, ui) {
            var minValue = ui.values[0];
            var maxValue = ui.values[1];
            ...
            // Adjust minValue based on different ranges
            if (minValue <= 1000) {
                minValue = Math.round(minValue / 50) * 50; // 0 to 1,000 with steps of 50
            } else if (minValue <= 5000) {
                minValue = Math.round((minValue - 1000) / 250) * 250 + 1000; // 1,000 to 5,000 with steps of 250
            } else {
                minValue = Math.round((minValue - 5000) / 1000) * 1000 + 5000; // 5,000 to 25,000 with steps of 1,000
            }
    
            // Adjust maxValue based on different ranges
            if (maxValue <= 1000) {
                maxValue = Math.round(maxValue / 50) * 50; // 0 to 1,000 with steps of 50
            } else if (maxValue <= 5000) {
                maxValue = Math.round((maxValue - 1000) / 250) * 250 + 1000; // 1,000 to 5,000 with steps of 250
            } else {
                maxValue = Math.round((maxValue - 5000) / 1000) * 1000 + 5000; // 5,000 to 25,000 with steps of 1,000
            }
    
            // Update the input fields
            $(".min_villa_landm2").val(addseparator(minValue));
            $(".max_villa_landm2").val(addseparator(maxValue));
        },
        stop: function(event, ui) {
            $(".min_villa_landm2").val(addseparator(ui.values[0]));
            $(".max_villa_landm2").val(addseparator(ui.values[1]));
        }
    });

    $(".min_villa_landm2").change(function() {
        $(".slider-range-villa_landm2").slider('values',0,$(this).val());
    });
    $(".max_villa_landm2").change(function() {
        $(".slider-range-villa_landm2").slider('values',1,$(this).val());
    });
    ...
    // for apartment_grossm2
    $(".slider-range-villa_bed").slider({
        range: true,
        min: 0,
        max: 20,
        values: [ 0, 20 ],
        slide: function( event, ui ) {
            $( ".min_villa_bed"  ).val( ui.values[ 0 ] );
            $( ".max_villa_bed"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_villa_bed").change(function() {
        $(".slider-range-villa_bed").slider('values',0,$(this).val());
    });
    $(".max_villa_bed").change(function() {
        $(".slider-range-villa_bed").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-villa_bath").slider({
        range: true,
        min: 0,
        max: 10,
        values: [ 0, 10 ],
        slide: function( event, ui ) {
            $( ".min_villa_bath"  ).val( ui.values[ 0 ] );
            $( ".max_villa_bath"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_villa_bath").change(function() {
        $(".slider-range-villa_bath").slider('values',0,$(this).val());
    });
    $(".max_villa_bath").change(function() {
        $(".slider-range-villa_bath").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-villa_living").slider({
        range: true,
        min: 0,
        max: 10,
        values: [ 0, 10 ],
        slide: function( event, ui ) {
            $( ".min_villa_living"  ).val( ui.values[ 0 ] );
            $( ".max_villa_living"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_villa_living").change(function() {
        $(".slider-range-villa_living").slider('values',0,$(this).val());
    });
    $(".max_villa_living").change(function() {
        $(".slider-range-villa_living").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-villa_floors").slider({
        range: true,
        min: 1,
        max: 10,
        values: [ 1, 10 ],
        slide: function( event, ui ) {
            $( ".min_villa_floors"  ).val( ui.values[ 0 ] );
            $( ".max_villa_floors"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_villa_floors").change(function() {
        $(".slider-range-villa_floors").slider('values',0,$(this).val());
    });
    $(".max_villa_floors").change(function() {
        $(".slider-range-villa_floors").slider('values',1,$(this).val());
    });


// ********************************* HOUSE ********************************

    $(".slider-range-house_grossm2").slider({
    range: true,
    min: 1,
    max: 2500,
    values: [1, 2500],
    slide: function(event, ui) {
        ...
        // Adjust minValue based on different ranges
        if (minValue <= 400) {
            minValue = Math.round(minValue / 25) * 25;  // 0 to 400 with steps of 25
        } else if (minValue <= 1500) {
            minValue = Math.round((minValue - 400) / 100) * 100 + 400;  // 400 to 1,500 with steps of 100
        } else if (minValue <= 2500) {
            minValue = Math.round((minValue - 1000) / 250) * 250 + 1000;  // 1,000 to 2,500 with steps of 250
        }
        ...
        // Adjust maxValue based on different ranges
        if (maxValue <= 400) {
            maxValue = Math.round(maxValue / 25) * 25;  // 0 to 400 with steps of 25
        } else if (maxValue <= 1500) {
            maxValue = Math.round((maxValue - 400) / 100) * 100 + 400;  // 400 to 1,500 with steps of 100
        } else if (maxValue <= 2500) {
            maxValue = Math.round((maxValue - 1000) / 250) * 250 + 1000;  // 1,000 to 2,500 with steps of 250
        }

        // Update input fields with formatted values
        $(".min_house_grossm2").val(addseparator(minValue));
        $(".max_house_grossm2").val(addseparator(maxValue));
    }
});

    $(".min_house_grossm2").change(function() {
        $(".slider-range-house_grossm2").slider('values',0,$(this).val());
    });
    $(".max_house_grossm2").change(function() {
        $(".slider-range-house_grossm2").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-house_landm2").slider({
        range: true,
        min: 1,
        max: 50000,
        values: [1, 50000],
        slide: function (event, ui) {
            ...
            // Adjust minValue based on different ranges
            if (minValue <= 500) {
                minValue = Math.round(minValue / 50) * 50;  // 0 to 500 with steps of 50
            } else if (minValue <= 1000) {
                minValue = Math.round((minValue - 500) / 100) * 100 + 500;  // 500 to 1,000 with steps of 100
            } else if (minValue <= 5000) {
                minValue = Math.round((minValue - 1000) / 250) * 250 + 1000;  // 1,000 to 5,000 with steps of 250
            } else if (minValue <= 20000) {
                minValue = Math.round((minValue - 5000) / 1000) * 1000 + 5000;  // 5,000 to 20,000 with steps of 1,000
            } else {
                minValue = Math.round((minValue - 20000) / 2500) * 2500 + 20000;  // 20,000 to 50,000 with steps of 2,500
            }
    
            // Adjust maxValue based on different ranges
            if (maxValue <= 500) {
                maxValue = Math.round(maxValue / 50) * 50;  // 0 to 500 with steps of 50
            } else if (maxValue <= 1000) {
                maxValue = Math.round((maxValue - 500) / 100) * 100 + 500;  // 500 to 1,000 with steps of 100
            } else if (maxValue <= 5000) {
                maxValue = Math.round((maxValue - 1000) / 250) * 250 + 1000;  // 1,000 to 5,000 with steps of 250
            } else if (maxValue <= 20000) {
                maxValue = Math.round((maxValue - 5000) / 1000) * 1000 + 5000;  // 5,000 to 20,000 with steps of 1,000
            } else {
                maxValue = Math.round((maxValue - 20000) / 2500) * 2500 + 20000;  // 20,000 to 50,000 with steps of 2,500
            }
    
            $(".min_house_landm2").val(addseparator(minValue));
            $(".max_house_landm2").val(addseparator(maxValue));
        }
    });

    $(".min_house_landm2").change(function() {
        $(".slider-range-house_landm2").slider('values',0,$(this).val());
    });
    $(".max_house_landm2").change(function() {
        $(".slider-range-house_landm2").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-house_bed").slider({
        range: true,
        min: 0,
        max: 20,
        values: [ 0, 20 ],
        slide: function( event, ui ) {
            $( ".min_house_bed"  ).val( ui.values[ 0 ] );
            $( ".max_house_bed"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_house_bed").change(function() {
        $(".slider-range-house_bed").slider('values',0,$(this).val());
    });
    $(".max_house_bed").change(function() {
        $(".slider-range-house_bed").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-house_bath").slider({
        range: true,
        min: 0,
        max: 10,
        values: [ 0, 10 ],
        slide: function( event, ui ) {
            $( ".min_house_bath"  ).val( ui.values[ 0 ] );
            $( ".max_house_bath"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_house_bath").change(function() {
        $(".slider-range-house_bath").slider('values',0,$(this).val());
    });
    $(".max_house_bath").change(function() {
        $(".slider-range-house_bath").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-house_living").slider({
        range: true,
        min: 0,
        max: 10,
        values: [ 0, 10 ],
        slide: function( event, ui ) {
            $( ".min_house_living"  ).val( ui.values[ 0 ] );
            $( ".max_house_living"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_house_living").change(function() {
        $(".slider-range-house_living").slider('values',0,$(this).val());
    });
    $(".max_house_living").change(function() {
        $(".slider-range-house_living").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-house_floors").slider({
        range: true,
        min: 1,
        max: 10,
        values: [ 1, 10 ],
        slide: function( event, ui ) {
            $( ".min_house_floors"  ).val( ui.values[ 0 ] );
            $( ".max_house_floors"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_house_floors").change(function() {
        $(".slider-range-house_floors").slider('values',0,$(this).val());
    });
    $(".max_house_floors").change(function() {
        $(".slider-range-house_floors").slider('values',1,$(this).val());
    });

// ************************** Building ****************

    $(".slider-range-building_grossm2").slider({
        range: true,
        min: 1,
        max: 10000,
        values: [1, 10000],
        slide: function(event, ui) {
            var minValue = Math.round(ui.values[0]);
            var maxValue = Math.round(ui.values[1]);
            ...
            if (minValue <= 1000) {
                ...
                minValue = Math.round((minValue - 5000) / 1000) * 1000 + 5000;  // 5,000 to 10,000 with steps of 1,000
            }
            ...
            if (maxValue <= 1000) {
                ...
                maxValue = Math.round((maxValue - 5000) / 1000) * 1000 + 5000;  // 5,000 to 10,000 with steps of 1,000
            }
    
            // Update input fields
            $(".min_building_grossm2").val(addseparator(minValue));
            $(".max_building_grossm2").val(addseparator(maxValue));
        }
    });
    $(".min_building_grossm2").val(1);
    $(".max_building_grossm2").val(10000);
    $(".min_building_grossm2").change(function() {
        $(".slider-range-building_grossm2").slider('values',0,$(this).val());
    });
    $(".max_building_grossm2").change(function() {
        $(".slider-range-building_grossm2").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-building_flats").slider({
        range: true,
        min: 0,
        max: 250,
        values: [ 0, 250 ],
        slide: function( event, ui ) {
            $( ".min_building_flats"  ).val( ui.values[ 0 ] );
            $( ".max_building_flats"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_building_flats").change(function() {
        $(".slider-range-building_flats").slider('values',0,$(this).val());
    });
    $(".max_building_flats").change(function() {
        $(".slider-range-building_flats").slider('values',1,$(this).val());
    });


    // for apartment_grossm2
    $(".slider-range-building_shops").slider({
        range: true,
        min: 0,
        max: 50,
        values: [ 0, 50 ],
        slide: function( event, ui ) {
            $( ".min_building_shops"  ).val( ui.values[ 0 ] );
            $( ".max_building_shops"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_building_shops").change(function() {
        $(".slider-range-building_shops").slider('values',0,$(this).val());
    });
    $(".max_building_shops").change(function() {
        $(".slider-range-building_shops").slider('values',1,$(this).val());
    });

    // for apartment_grossm2
    $(".slider-range-building_floors").slider({
        range: true,
        min: 1,
        max: 70,
        values: [ 1, 70 ],
        slide: function( event, ui ) {
            $( ".min_building_floors"  ).val( ui.values[ 0 ] );
            $( ".max_building_floors"  ).val( ui.values[ 1 ] );
        }
    });
    $(".min_building_floors").change(function() {
        $(".slider-range-building_floors").slider('values',0,$(this).val());
    });
    $(".max_building_floors").change(function() {
        $(".slider-range-building_floors").slider('values',1,$(this).val());
    });

// ************************** Land ****************

    $(".slider-range-land_grossm2").slider({
    range: true,
    min: 1,
    max: 100000,
    values: [1, 100000],
    slide: function(event, ui) {
        ...
        // Adjust minValue based on different ranges
        if (minValue <= 1000) {
            minValue = Math.round(minValue / 25) * 25;  // 0 to 1,000 with steps of 25
        } else if (minValue <= 3000) {
            minValue = Math.round((minValue - 1000) / 200) * 200 + 1000;  // 1,000 to 3,000 with steps of 200
        } else if (minValue <= 10000) {
            minValue = Math.round((minValue - 3000) / 500) * 500 + 3000;  // 3,000 to 10,000 with steps of 500
        } else if (minValue <= 30000) {
            minValue = Math.round((minValue - 10000) / 1000) * 1000 + 10000;  // 10,000 to 30,000 with steps of 1,000
        } else if (minValue <= 100000) {
            minValue = Math.round((minValue - 30000) / 5000) * 5000 + 30000;  // 30,000 to 100,000 with steps of 5,000
        }

        // Adjust maxValue based on different ranges
        if (maxValue <= 1000) {
            maxValue = Math.round(maxValue / 25) * 25;  // 0 to 1,000 with steps of 25
        } else if (maxValue <= 3000) {
            maxValue = Math.round((maxValue - 1000) / 200) * 200 + 1000;  // 1,000 to 3,000 with steps of 200
        } else if (maxValue <= 10000) {
            maxValue = Math.round((maxValue - 3000) / 500) * 500 + 3000;  // 3,000 to 10,000 with steps of 500
        } else if (maxValue <= 30000) {
            maxValue = Math.round((maxValue - 10000) / 1000) * 1000 + 10000;  // 10,000 to 30,000 with steps of 1,000
        } else if (maxValue <= 100000) {
            maxValue = Math.round((maxValue - 30000) / 5000) * 5000 + 30000;  // 30,000 to 100,000 with steps of 5,000
        } else {
            maxValue = '∞';  // Values over 100,000 show as "infinity"
        }

        // Update input fields
        $(".min_land_grossm2").val(addseparator(minValue));
        $(".max_land_grossm2").val(addseparator(maxValue));
    }
});

    $(".min_land_grossm2").change(function() {
        $(".slider-range-land_grossm2").slider('values',0,$(this).val());
    });
    $(".max_land_grossm2").change(function() {
        $(".slider-range-land_grossm2").slider('values',1,$(this).val());
    });


    $(".slider-range-land_pricem2").slider({
        range: true,
        min: 1,
        max: 1000000,
        values: [ 1, 1000000 ],
        slide: function( event, ui ) {
            $( ".min_land_pricem2"  ).val( addseparator(ui.values[ 0 ] ));
            $( ".max_land_pricem2"  ).val( addseparator(ui.values[ 1 ] ));
        }
    });
    $(".min_land_pricem2").change(function() {
        $(".slider-range-land_pricem2").slider('values',0,$(this).val());
    });
    $(".max_land_pricem2").change(function() {
        $(".slider-range-land_pricem2").slider('values',1,$(this).val());
    });
    
    var slider = document.getElementById('price-slider');
    var symbol = document.getElementById('currency_symbol');
    var currencySymbol = symbol.value;
    
    noUiSlider.create(slider, {
        start: [0, 100000000],  // Initial start and end points
        connect: true,
        range: {
            'min': 0,                           // 0
            '10%': [100000, 2500],              // 0 to 100,000 in steps of 2,500
            '20%': [500000, 10000],             // 100,000 to 500,000 in steps of 10,000
            '40%': [2500000, 50000],            // 500,000 to 2,500,000 in steps of 50,000
            '60%': [5000000, 100000],           // 2,500,000 to 5,000,000 in steps of 100,000
            '80%': [20000000, 1000000],         // 5,000,000 to 20,000,000 in steps of 1,000,000
            'max': [100000000, 5000000]         // 20,000,000 to 100,000,000 in steps of 5,000,000
        },
        step: 1,  // Fine control for adjustments
        tooltips: [false, false],  // Tooltips on both ends
        format: {
            to: function (value) {
                // Display "∞" for values over 100,000,000
                if (value > 100000000) {
                    return '∞';
                }
                return currencySymbol + Math.round(value).toLocaleString();  // Format with commas
            },
            from: function (value) {
                // Convert from string to number, handle infinity symbol
                return value === '∞' ? 100000000 : Number(value.replace(currencySymbol, '').replace(/\,/g, ''));
            }
        }
    });
    
    // Adjust minValue and maxValue dynamically based on specific ranges and step increments
    slider.noUiSlider.on('update', function (values) {
        // Remove the currency symbol and commas from the value
        var minValue = Number(values[0].replace(currencySymbol, '').replace(/,/g, ''));
        var maxValue = Number(values[1].replace(currencySymbol, '').replace(/,/g, ''));
        
        // Adjust minValue
        if (minValue <= 100000) {
            minValue = Math.round(minValue / 2500) * 2500;  // 0 to 100,000 with steps of 2,500
        } else if (minValue <= 500000) {
            minValue = Math.round((minValue - 100000) / 10000) * 10000 + 100000;  // 100,000 to 500,000 with steps of 10,000
        } else if (minValue <= 2500000) {
            minValue = Math.round((minValue - 500000) / 50000) * 50000 + 500000;  // 500,000 to 2,500,000 with steps of 50,000
        } else if (minValue <= 5000000) {
            minValue = Math.round((minValue - 2500000) / 100000) * 100000 + 2500000;  // 2,500,000 to 5,000,000 with steps of 100,000
        } else if (minValue <= 20000000) {
            minValue = Math.round((minValue - 5000000) / 1000000) * 1000000 + 5000000;  // 5,000,000 to 20,000,000 with steps of 1,000,000
        } else {
            minValue = Math.round((minValue - 20000000) / 5000000) * 5000000 + 20000000;  // 20,000,000 to 100,000,000 with steps of 5,000,000
        }
        
        // Adjust maxValue
        if (maxValue <= 100000) {
            maxValue = Math.round(maxValue / 2500) * 2500;  // 0 to 100,000 with steps of 2,500
        } else if (maxValue <= 500000) {
            maxValue = Math.round((maxValue - 100000) / 10000) * 10000 + 100000;  // 100,000 to 500,000 with steps of 10,000
        } else if (maxValue <= 2500000) {
            maxValue = Math.round((maxValue - 500000) / 50000) * 50000 + 500000;  // 500,000 to 2,500,000 with steps of 50,000
        } else if (maxValue <= 5000000) {
            maxValue = Math.round((maxValue - 2500000) / 100000) * 100000 + 2500000;  // 2,500,000 to 5,000,000 with steps of 100,000
        } else if (maxValue <= 20000000) {
            maxValue = Math.round((maxValue - 5000000) / 1000000) * 1000000 + 5000000;  // 5,000,000 to 20,000,000 with steps of 1,000,000
        } else {
            maxValue = Math.round((maxValue - 20000000) / 5000000) * 5000000 + 20000000;  // 20,000,000 to 100,000,000 with steps of 5,000,000
        }
        
        // Format the values with currency symbol and commas
        document.getElementById('min_price').value = currencySymbol + minValue.toLocaleString();
        document.getElementById('max_price').value = currencySymbol + maxValue.toLocaleString();
       ...
       var slidergross = document.getElementById('range_apartment_grossm2');

        noUiSlider.create(slidergross, {
            start: [0, 1000],  // Initial start of the slider (from 0 to 1000)
            connect: true,
            range: {
                'min': 0,
                '25%': 250,   // 25% of the slider will cover 0 - 250
                'max': 1000   // The rest (75%) will cover 250 - 1000
            },
            step: 1,  // Step value of 1 to allow finer control
            tooltips: [false, false],  // Show tooltips on both ends
            format: {
                to: function (value) {
                    return Math.round(value); // Round the values displayed in the tooltip
                },
                from: function (value) {
                    return Number(value); // Convert from string to number
                }
            }
        });
        
        // Update the input fields dynamically
        slidergross.noUiSlider.on('update', function (values) {
            var minValue = Math.round(values[0]);
            var maxValue = Math.round(values[1]);
        
            // Adjust stepping behavior based on current value
            if (minValue <= 250) {
                minValue = Math.round(minValue / 10) * 10;  // Round min to nearest 10 for 0-250
            } else {
                minValue = Math.round((minValue - 250) / 50) * 50 + 250;  // Step by 50 after 250
            }
        
            if (maxValue <= 250) {
                maxValue = Math.round(maxValue / 10) * 10;  // Round max to nearest 10 for 0-250
            } else {
                maxValue = Math.round((maxValue - 250) / 50) * 50 + 250;  // Step by 50 after 250
            }
        
            document.getElementById('min_apartment_grossm2').value = minValue;  // Update min input
            document.getElementById('max_apartment_grossm2').value = maxValue;  // Update max input
        });
