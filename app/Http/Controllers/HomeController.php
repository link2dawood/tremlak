...
class HomeController extends Controller
{
    public function admin_dashboard(GoogleAnalyticsService $analyticsService){
        ...
        try {
            ...
            $todayVisitors = 0; // Use a fallback value
        }
    ...
    public function analytics()
{
    try {
        ...
        $data = [
            ...
            'visitorsByCountry' => [],
            'visitorsByDate' => [],
            'errorMessage' => 'Unable to fetch analytics data: ' . $e->getMessage()
        ];
    }
    ...
    public function index(){
        ...
        return view('pages.index',compact('cities','properties','featured_properties'));
