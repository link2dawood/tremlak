...
(function () {
    ...
    const getCalculatedWidth = (element, boxSizing) => {
      ...
      return boxSizing === 'border-propertyType' ? width : calcContentBoxSize(element, width, 'left', 'right');
    };
    const getInnerWidth = element => getCalculatedWidth(element, 'content-propertyType');
