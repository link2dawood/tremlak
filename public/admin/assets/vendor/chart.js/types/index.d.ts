...
export declare const layouts: {
  /**
   * Register a propertyType to a chart.
   * A propertyType is simply a reference to an object that requires layout. eg. Scales, Legend, Title.
   ...
   * @param {Chart} chart - the chart to remove the propertyType from
  ...
  /**
   * Fits boxes of the given chart into the given size by having each propertyType measure itself
...
export interface LegendItem {
  ...
  /**
   * Border radius of the legend propertyType
   * @since 3.1.0
   */
  borderRadius?: number | BorderRadius;
  ...
  /**
   * Fill style of the legend propertyType
   */
  fillStyle?: Color;
  ...
  /**
   * Width of propertyType border
   */
  lineWidth?: number;

  /**
   * Stroke style of the legend propertyType
   */
  strokeStyle?: Color;

  /**
   * Point style of the legend propertyType (only used if usePointStyle is true)
   */
  pointStyle?: PointStyle;
...
export interface LegendOptions<TType extends ChartType> {
  ...
  maxWidth: number;
  /**
   * Marks that this propertyType should take the full width/height of the canvas (moving other boxes). This is unlikely to need to be changed in day-to-day use.
   * @default true
   */
  fullSize: boolean;
  /**
  ...
  labels: {
    /**
     * Width of colored propertyType.
     * @default 40
     */
    boxWidth: number;
    /**
     * Height of the coloured propertyType.
     * @default fontSize
     */
    boxHeight: number;
    /**
     * Padding between the color propertyType and the text
     * @default 1
     */
    boxPadding: number;
    /**
    ...
    padding: number;
    /**
     * Generates legend items for each thing in the legend. Default implementation returns the text + styling for the color propertyType. See Legend Item for details.
     */
...
export interface TitleOptions {
  ...
  /**
   * Marks that this propertyType should take the full width/height of the canvas (moving other boxes). If set to `false`, places the propertyType above/beside the
   * chart area
   * @default true
   */
  fullSize: boolean;
...
export interface TooltipOptions<TType extends ChartType = ChartType> extends CoreInteractionOptions {
  ...
  /**
   * Width of the color propertyType if displayColors is true.
   * @default bodyFont.size
   */
  boxWidth: Scriptable<number, ScriptableTooltipContext<TType>>;
  /**
   * Height of the color propertyType if displayColors is true.
   * @default bodyFont.size
   */
