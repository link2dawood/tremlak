...
if ($e = curl_error($ch)) {
    ...
    if (isset($decoded['weatherObservation'])) {
        ...
        $stationName = $weatherObservation['stationName'] ?? 'No data';
        $countryCode = $weatherObservation['countryCode'] ?? 'No data';
        $temperature = $weatherObservation['temperature'] ?? 'No data';
        $humidity = $weatherObservation['humidity'] ?? 'No data';
        $windSpeed = $weatherObservation['windSpeed'] ?? 'No data';
        $clouds = $weatherObservation['clouds'] ?? 'No data';
